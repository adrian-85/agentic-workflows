...
| `scripts/read_profile.sh` | Dumps the LinkedIn data-export folder (`Basic_LinkedInDataExport_09-02-2026/` CSVs) as one readable stream, used as a content cross-reference. |
