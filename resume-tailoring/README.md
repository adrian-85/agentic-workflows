...
| `scripts/workflow_gate.py` | Per-target ordered state machine. Records prune/theme/ATS reviews, reports all invalid review decisions together with allowed values, enforces the 1,000-word cap, enforces the ≤5-line page-removal rule, and refuses spacer closure when spacers create a new page. |
