...
def save(path, root, names, data, *, drift=None):
    ...
    master_changed = drift_sidecar(path, drift, applied, root)
...
def set_text(p, text):
    ...
    This REPLACES the paragraph's content — it cannot insert. To ADD a new
...
if __name__ == "__main__":
    import importlib
    sys.exit(importlib.import_module("docx_edit_cli").cli(sys.argv))
